...
#            together. Demonstrating hoe to pass variables from function
#            to function while producing a functional game.
#
#            Remember, function_name(variable)_ means that we pass in the 
#            variable. Return variable _means that we are returning the
